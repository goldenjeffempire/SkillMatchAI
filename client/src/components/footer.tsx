...
export function Footer() {
  return (
    <footer className="bg-background pt-16 pb-8 px-4 border-t border-primary/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">EchoWriter</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">EchoBuilder</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">EchoSeller</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">EchoMarketer</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">EchoDevBot</a></li>
            </ul>
          </div>
